...
def change_speed(input_path: str, speed: float) -> Tuple[str, float]:
    """Time-stretch audio while keeping pitch constant."""
    ...
    # ffmpeg's atempo preserves pitch for values between 0.5 and 2.0.
...
with colB:
    ...
    words_per_line = st.slider("Woorden per regel (indicatie)", 4, 14, 8, 1)
